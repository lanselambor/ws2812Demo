      ...
      if(millis() - start_scroll > 60)
      {
        ...
        switch(color)
        {
          case 0:
            ...
            strip1.setPixelColor(i, strip.Color(0,255,0)); // Moderately bright green color. 
            break;
          case 1:
            strip.setPixelColor(i, strip.Color(255,0,0)); // Moderately bright red color.  
            strip1.setPixelColor(i, strip.Color(255,0,0)); // Moderately bright red color.  
            break;        
          case 2:
            strip.setPixelColor(i, strip.Color(0,0,255)); // Moderately bright blue color.  
            strip1.setPixelColor(i, strip.Color(0,0,255)); // Moderately bright blue color.  
            break;
          default:
            break;        
        }   
